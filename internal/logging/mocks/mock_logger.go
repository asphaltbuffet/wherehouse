...
func (_mock *MockLogger) With(args ...any) logging.Logger {
	var _ca []interface{}
	_ca = append(_ca, args...)
	...
	if returnFunc, ok := ret.Get(0).(func(...any) logging.Logger); ok {
		r0 = returnFunc(args...)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockLogger_With_Call) Return(logger logging.Logger) *MockLogger_With_Call {
	_c.Call.Return(logger)
	return _c
}

func (_c *MockLogger_With_Call) RunAndReturn(run func(args ...any) logging.Logger) *MockLogger_With_Call {
	_c.Call.Return(run)
	return _c
}
